    ...
    public partial class DocumentManagementForm : Form
    {
        ...
        private void BtnLoadFiles_Click(object sender, EventArgs e)
        {
            using (var openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    ActivityLogger.Log(loggedInUser, $"Carregou arquivos: {string.Join(", ", openFileDialog.FileNames.Select(Path.GetFileName))}");
                }
            }
        }
        ...
        private void BtnSaveFiles_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ActivityLogger.Log(loggedInUser, $"Arquivos salvos na categoria '{selectedCategory}' e subcategoria '{selectedSubCategory}'.");
        ...
        private void BtnDeleteFiles_Click(object sender, EventArgs e)
        {
            if (listBoxFiles.SelectedItems.Count > 0)
            {
                ...
                if (confirmResult == DialogResult.Yes)
                {
                    ...
                    ActivityLogger.Log(loggedInUser, $"Excluiu documentos: {string.Join(", ", listBoxFiles.SelectedItems.Cast<string>())}");
        ...
        {
            lstFiles.Items.Clear();
            ActivityLogger.Log(loggedInUser, "Limpou a lista de arquivos.");
        }
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            ActivityLogger.Log(loggedInUser, $"Realizou pesquisa por '{searchPattern}' na categoria '{selectedCategory}' e subcategoria '{selectedSubCategory}'.");
        }
